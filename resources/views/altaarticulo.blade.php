...
<figure class="text-center">
    <blockquote class="blockquote">
      <h2>Ingresar Datos del Articulo</h2>
    </blockquote>

  </figure>
    <div class="container">
        <form method="POST" action="{{route('ProcesoArticulo')}}">
            @csrf
            ...
            <br>
            <div class="row justify-content-center"> <button class="btn btn-primary" type="submit">Guardar Articulo</button></div>
