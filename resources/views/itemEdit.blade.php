...
@section('content')
    <div class="container col-7">
        ...
        <div class="card text-center mb-5">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('item.update', $consultaId->Id_item) }}">
                    @csrf
                    {!! method_field('PUT') !!}
                    ...
                    <div class="form-group">
                        <input name="Type" class="form-control border-2" type="text" placeholder="Edition"
                            style="background-color: #e1eefe;" value="{{ $consultaId->Type }}">
                        <p class='card-title fw-bold text-start' style="color:#D90404">
                            <u>
                                {{ $errors->first('Type') }}
                            </u>
                    ...
                    <div class="form-group">
                        <input name="Description" class="form-control border-2" type="text" placeholder="Company"
                            style="background-color: #e1eefe;" value="{{ $consultaId->Description }}">
                        <p class='card-title fw-bold text-start' style="color:#D90404">
                            <u>
                    ...
                    <div class="card-footer">
                        <button class="btn btn-primary" type="submit">Actualizar item</button>
                    </div>
                </form>
            </div>
        </div>
